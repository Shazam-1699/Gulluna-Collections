...
function Bottoms() {
    return (
        <div className="tops-container">
           ...
           <h3 id="Header1" > <a href="/home"> <span id="spanHeader1">Home  </span> </a>  / <a href="/categories">Categories </a> / <a href="/bottoms"> Bottoms </a> </h3>

           <div id="display">
            <h1 id="display-heading">Trendy Bottoms For All Ocassion _ Gulluna</h1>
